                    ...
                    <a class="rounded-xl cursor-pointer flex flex-col overflow-hidden relative ring-0 bg-[#FFFFFF]"
                        ...
                        <div class="relative">
                            <div class="relative"
                                ...
                                <img class="opacity-100 bottom-0 h-full left-0 absolute right-0 top-0 w-full"
                                    ...
                                    :alt="itemInforPromo.nameProduct">
                            </div>
                        </div>
                        <div class="flex flex-1 flex-col p-4">
                            ...
                            style="row-gap: calc(0.5rem*-1); column-gap: calc(0.5rem*-1);">
                                <template v-if="itemInforPromo.inforProduct1">
                                    <div class="flex flex-wrap ml-[calc(0.5rem*-1)] mt-[calc(0.5rem*-1)]">
                                        <div
                                            ...
                                            {{ itemInforPromo.inforProduct1 }}
                                        </div>
                                        <template v-if="itemInforPromo.inforProduct2">
                                            <div class="rounded cursor-pointer inline-flex text-xs whitespace-nowrap px-2 py-[2px] ml-2 mt-2 text-[#1C1F23] bg-[#F6F9FC] leading-[150%]">
                                                {{ itemInforPromo.inforProduct2 }}
                                            </div>
                                        </template>
                                        <template v-if="itemInforPromo.inforProduct3">
                                            <div class="rounded cursor-pointer inline-flex text-xs whitespace-nowrap px-2 py-[2px] ml-2 mt-2 text-[#1C1F23] bg-[#F6F9FC] leading-[150%]">
                                                {{ itemInforPromo.inforProduct3 }}
                                            </div>
                                        </template>
                                        <template v-if="itemInforPromo.inforProduct4">
                                            <div class="rounded cursor-pointer inline-flex text-xs whitespace-nowrap px-2 py-[2px] ml-2 mt-2 text-[#1C1F23] bg-[#F6F9FC] leading-[150%]">
