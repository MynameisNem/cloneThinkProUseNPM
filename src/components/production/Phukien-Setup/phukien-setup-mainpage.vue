...
export default {
    ...
    data() {
        return {
            pContent: "Phụ kiện & Setup",
            pText: "Phụ kiện & Setup bao gồm nhiều sản phẩm khác nhau, phục vụ đa nhu cầu của người dùng. Một số phụ kiện đáng chú ý như: kê tay bàn phím, ốp lưng, dán màn hình, phủ phím, ...",
            itemsBranch: [
